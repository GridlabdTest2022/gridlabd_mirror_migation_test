...
#             dstSRS = "EPSG:4326",
    ...
    output_file = f"/opt/gridlabd/share/gridlabd/geodata/vegetation/2020/{name}.tif"
    ...
    for coordinate in coordinates:
        ...
        for lat in lats:
            for lon in lons:
                ...
                print(name)
                if not os.path.exists(f"/opt/gridlabd/share/gridlabd/geodata/vegetation/2020/{name}.tif"):
                    print(f"Downloading " + name)
                    get_image(layer, (lat,lon), forest, name,
                              cachedir = "/opt/gridlabd/share/gridlabd/geodata/vegetation")
                    tile = get_imagedata(layer, (lat,lon), scale = 0.1,
                                         repourl = "http://geodata.gridlabd.us/vegetation",
                                         cachedir = "/opt/gridlabd/share/gridlabd/geodata/vegetation")
                
                srcname = f"/opt/gridlabd/share/gridlabd/geodata/vegetation/2020/{name}.tif"
